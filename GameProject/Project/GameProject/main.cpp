...
void MainLoop(void) {
	...
	ObjectBase::CheckKillAll();
	ObjectBase::UpdateAll();
	ObjectBase::CollisionAll();
	ObjectBase::DrawAll();
...
//	CInput::SetMouseInside(true);
	...
	ADD_RESOURCE("PlayerBullet", CImage::CreateImage("Player/PlayerBullet.png", PlayerBullet::_anim_data, 64, 64));
